            ...
            <div class="container">
                ...
                <div>
                    ...
                    <details>
                        ...
                        <p>Биржи фриланса — интернет-платформы для удаленной подработки — помогают студентам получить первый источник дохода. Это позволяет в свободное от учебы время не только получить дополнительный заработок, но и повысить практические навыки в рамках своей дисциплины. Для этого студентам не нужно никуда выходить из дома — достаточно иметь при себе собственный ПК или ноутбук и постоянное интернет-соединение.</p>
                    </details>
                </div>
            </div>
        </main>
